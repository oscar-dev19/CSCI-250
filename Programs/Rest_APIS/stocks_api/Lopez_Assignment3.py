...
def main():
    ROOT_DATA_PATH = 'data/'
    nasdaq_path = f'{ROOT_DATA_PATH}companylist_nasdaq.csv'
    nyse_path = f'{ROOT_DATA_PATH}companylist_nyse.csv'
    amex_path = f'{ROOT_DATA_PATH}companylist_amex.csv'

    data_dict = parse_file_as_dict(nasdaq_path, nyse_path, amex_path)
    data_list = parse_file_as_list(nasdaq_path, nyse_path, amex_path)
